...
public class ServerHandler10013 extends SimpleChannelInboundHandler<Result10013> {
    /**
     * 当从客户端接收到一个消息时被调用
     * msg 解析后的数据信息
     */
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, Result10013 message) {
