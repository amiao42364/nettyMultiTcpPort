...
public class ServerHandler10014 extends SimpleChannelInboundHandler<Result10014> {
     ...
     */
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, Result10014 message) {
